...
<head>
    ...
    <script>
        // Tema "Void-canvas agent noir" (2026-08-29, ver testing frontend/framer-design.md,
        // fuente: framer.com) -- reemplaza el tema neon anterior (rechazado por el dueño).
        // Mismo mecanismo: remapear slate/cyan en tailwind.config cascadea a las ~49
        // plantillas que ya usaban esos tokens, sin editar clase por clase. A diferencia
        // del tema neon, este spec pide esquinas redondeadas moderadas (8-20px), no planas.
        tailwind.config = {
            darkMode: 'class',
            theme: {
                extend: {
